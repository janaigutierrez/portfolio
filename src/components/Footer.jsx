export default function Footer() {
    ...
    return (
        <footer className="bg-gris-carbo text-white py-12">
            <div className="container mx-auto px-6">
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-300 leading-relaxed">
                            Desenvolupador creatiu especialitzat en crear experiències digitals
                            innovadores i solucions tecnològiques que marquen la diferència.
                        </p>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2 text-gray-300">
                            <p>📧 janai@example.com</p>
                            <p>📍 Tarragona, Catalunya</p>
                            <p>💼 Disponible per projectes</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
                    <p>&copy; {currentYear} Janai Gutierrez. Dissenyat i desenvolupat amb ❤️</p>
                </div>
            </div>
        </footer>
    )
