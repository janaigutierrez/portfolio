export default {
    ...
    about: {
        ...
        approach: "Com a desenvolupador full stack, puc afrontar qualsevol repte: des de portals web fins a automatitzacions, plataformes SaaS o CRMs. El meu enfocament és sempre el mateix: entendre profundament les necessitats del client i dissenyar la solució més personalitzada possible, prioritzant l'experiència d'usuari per construir serveis intuïtius i atractius.",

        skills: {
            frontend: "Frontend",
            backend: "Backend",
            tools: "Eines i Deploy"
        },
    ...
    projects: {
        ...
        categories: {
            ...
            saasAndSystems: "SaaS i Sistemes",
            customWebsites: "Webs Personalitzades",
            interactiveProjects: "Projectes Interactius"
        },

        ui: {
            progress: "Progrés",
            keyFeatures: "Característiques Clau",
            technologyStack: "Stack Tecnològic",
        ...
        terracota: {
            name: "Terracota",
            subtitle: "Plataforma de Gestió Empresarial",
        ...
        canCarerac: {
            name: "Can Carerac",
            subtitle: "Experiències Gastronòmiques",
